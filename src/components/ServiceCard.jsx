  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="flex flex-col sm:flex-row justify-around w-full gap-4 mb-10">
        ...
        <div className="flex-1 animate-slideInLeft sm:w-1/2">
          <img
            src={steel}
            alt="Steel"
        ...
        <div className="flex-1 animate-fadeIn sm:w-1/2">
          <img
            src={interior}
            alt="Interior"
            className="w-full h-40 sm:h-60 border border-gray-400 rounded-lg px-4 py-6 sm:px-8 sm:py-12 hover:shadow-[4px_4px_0_#000] cursor-pointer hover:bg-[#fcf4ff] hover:-translate-y-1 duration-500"
          />
